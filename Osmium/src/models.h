...
extern struct model mod_spider;
extern struct model mod_pig;
extern struct model mod_pigsaddle;
extern struct model mod_sheep;
extern struct model mod_sheepwool;
extern struct model mod_cow;
extern struct model mod_wolf;
extern struct model mod_chicken;
extern struct model mod_ocelot;
extern struct model mod_rabbit;
extern struct model mod_silverfish;
extern struct model mod_endermite;
extern struct model mod_creeper;
extern struct model mod_creepercharge;
extern struct model mod_enderman;
extern struct model mod_snowman;
extern struct model mod_skeleton;
extern struct model mod_skeletonleggings;
extern struct model mod_skeletonarmor;
extern struct model mod_witch;
extern struct model mod_blaze;
extern struct model mod_zombie;
extern struct model mod_zombieleggings;
extern struct model mod_zombiearmor;
extern struct model mod_zombievillager;
extern struct model mod_slime;
extern struct model mod_slimegel;
extern struct model mod_magmacube;
extern struct model mod_ghast;
extern struct model mod_squid;
extern struct model mod_villager;
extern struct model mod_irongolem;
extern struct model mod_bat;
extern struct model mod_guardian;
extern struct model mod_shulker;
extern struct model mod_dragon;
extern struct model mod_endercrystal;
extern struct model mod_endercrystalbaseless;
extern struct model mod_wither;
extern struct model mod_witheraura;
extern struct model mod_leashknot;
extern struct model mod_witherskull;
extern struct model mod_shulkerbullet;
extern struct model mod_armorstand;
extern struct model mod_armorstandleggings;
extern struct model mod_armorstandarmor;
extern struct model mod_minecarttnt;
extern struct model mod_minecartmobspawner;
extern struct model mod_minecart;
extern struct model mod_boat;
extern struct model mod_horse;
extern struct model mod_player;
extern struct model mod_playerleggings;
extern struct model mod_playerarmor;
extern struct model mod_playerelytra;
extern struct model mod_splayer;
extern struct model mod_splayerleggings;
extern struct model mod_splayerarmor;
extern struct model mod_splayerelytra;
